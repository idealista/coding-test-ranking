...
public class PhotoScoringTest {

    private Scoring scoring;

    @Before
    public void setUp() {
        scoring = new PhotoScoring();
    }
    ...
    @Test
    public void shouldReturnAdVOWithCalculatedScoringWhenAdVOHasNoPictures() {
        //given
    ...
    public void shouldReturnAdVOWithScoringCalculatedWhenAdVOHasNullScore() {
        ...
        //then
        assertThat(out, is(notNullValue()));
        assertThat(out.getScore(), is(10 + 20));
    }
    ...
    public void shouldReturnAdVOWithScoringAddedWhenAdVOHasPreviousScore() {
        ...
        //then
        assertThat(out, is(notNullValue()));
        assertThat(out.getScore(), is(initialScore + 10 + 20));
    }
