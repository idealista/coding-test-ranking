...
import com.idealista.infrastructure.api.inbound.RetrievePublicAdsController;
...
@WebMvcTest(controllers = RetrievePublicAdsController.class)
@ContextConfiguration(classes = {Config.class})
@AutoConfigureMockMvc(addFilters = false)
@ActiveProfiles({"test", "it", "rest"})
public class RetrievePublicAdsEndpointIT {

    @Autowired
    private MockMvc mockMvc;

    @MockBean
    private RetrievePublicAds retrievePublicAds;
    ...
    void shouldCalculateTheScoreForTheStoredAds() throws Exception {
        //given
        BDDMockito.given(retrievePublicAds.execute()).willReturn(asList(
        ...
        //when
        final ResultActions resultActions = mockMvc.perform(get("/api/1/ad/public-ads"));
